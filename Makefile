#############################################################################
# Makefile for building: OneClientPP
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  OneClientPP.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile OneClientPP.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = OneClientPP1.0.0
DISTDIR = /home/joonatoona/src/OpenMineMods/OneClientPP/.tmp/OneClientPP1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		OneClientPP.pro GUI/MainWindow.h main.cpp \
		GUI/MainWindow.cpp
QMAKE_TARGET  = OneClientPP
DESTDIR       = 
TARGET        = OneClientPP
...
Makefile: OneClientPP.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile OneClientPP.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp GUI/MainWindow.cpp $(DISTDIR)/
